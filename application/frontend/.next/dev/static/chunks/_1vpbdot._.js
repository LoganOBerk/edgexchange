...
function Toaster() {
    ...
    if ($[0] !== "e86f796c94fafb85045c5b0e050f0a506fb086eaf6857dfdbd300c2317c742cf") {
        for(let $i = 0; $i < 6; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "e86f796c94fafb85045c5b0e050f0a506fb086eaf6857dfdbd300c2317c742cf";
    }
...
"[project]/context/PortfolioContext.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/compiler-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$SessionContext$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/context/SessionContext.js [app-client] (ecmascript)");
;
...
const PortfolioContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(null);
const usePortfolio = ()=>{
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(1);
    if ($[0] !== "55ce2f7b0b0205e4fc31458747e3cd348a663d276afa4ca1681edd7638e6c37d") {
        for(let $i = 0; $i < 1; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "55ce2f7b0b0205e4fc31458747e3cd348a663d276afa4ca1681edd7638e6c37d";
    }
    const ctx = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(PortfolioContext);
    if (!ctx) {
        throw new Error("usePortfolio must be used within PortfolioProvider");
    }
    return ctx;
};
_s(usePortfolio, "/dMy7t63NXD4eYACoT93CePwGrg=");
const PortfolioProvider = ({ children })=>{
    _s1();
    const { sessionId, user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$SessionContext$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSession"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PortfolioProvider.useEffect": ()=>{
            ...
            fetch(url, {
                ...
                "PortfolioProvider.useEffect": async (res)=>{
                        ...
                        for (const line of decoder.decode(value).trim().split("\n")){
                            ...
                            try {
                                ...
                                for (const entry of parsed.portfolios ?? []){
                                    ...
                                    setLiveData({
                                        "PortfolioProvider.useEffect": (prev)=>{
                                            const next = {
                                                ...prev,
            ...
            }["PortfolioProvider.useEffect"]).catch({
                "PortfolioProvider.useEffect": (err)=>{
                    if (err.name !== "AbortError") console.error("Stream error", err);
                }
            }["PortfolioProvider.useEffect"]);
            return ({
                "PortfolioProvider.useEffect": ()=>controller.abort()
            })["PortfolioProvider.useEffect"];
        }
    }["PortfolioProvider.useEffect"], [
        sessionId,
        Object.keys(user?.portfolios ?? {}).join(",")
    ]);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(PortfolioContext.Provider, {
        ...
        fileName: "[project]/context/PortfolioContext.jsx",
        lineNumber: 85,
        columnNumber: 10
    }, ("TURBOPACK compile-time value", void 0));
};
_s1(PortfolioProvider, "UTDBEYecaIAtR0RicqPsATt4iCc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$SessionContext$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSession"]
    ];
});
...
"[project]/context/SessionContext.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const isTesting = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_TESTING === "true";
...
function SessionProvider(t0) {
    ...
    if ($[0] !== "b6f7285f612fad96e6b5fadaf3234d813a43ea021358d2ba1e14ece95df254a9") {
        for(let $i = 0; $i < 20; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "b6f7285f612fad96e6b5fadaf3234d813a43ea021358d2ba1e14ece95df254a9";
    }
    const { children } = t0;
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const [sessionId, setSessionId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(_SessionProviderUseState);
    const [user, setUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(_SessionProviderUseState2);
        ...
        t1 = ({
            "SessionProvider[useEffect()]": ()=>{
                ...
                fetch(`${API_BASE}/user?session_id=${stored}`, {
                    ...
                    "SessionProvider[useEffect() > (anonymous)()]": async (res)=>{
                        if (res.status === 401) {
                            clearSession();
                            setSessionId(null);
                            setUser(null);
                ...
                }["SessionProvider[useEffect() > (anonymous)()]"]).catch({
                    "SessionProvider[useEffect() > (anonymous)()]": (err)=>{
                ...
                }["SessionProvider[useEffect() > (anonymous)()]"]);
    ...
    if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
        const persistUser = {
            "SessionProvider[persistUser]": (id, user_0)=>{
                setSessionId(id);
                setUser(user_0);
                store.set("session_id", id);
                store.set("user", JSON.stringify(user_0));
                setSessionCookie(id);
            }
        }["SessionProvider[persistUser]"];
        t3 = ({
            "SessionProvider[login_0]": async (login, password)=>{
                const data_0 = await loginUser(login, password);
                persistUser(data_0.session_id, data_0.user);
                return data_0;
            }
        })["SessionProvider[login_0]"];
        $[4] = t3;
    } else {
        t3 = $[4];
    }
    const login_0 = t3;
    let t4;
    if ($[5] !== router || $[6] !== sessionId) {
        t4 = ({
            "SessionProvider[logout]": async ()=>{
                try {
                    if (sessionId) {
    ...
    if ($[8] !== router) {
        t5 = ({
            "SessionProvider[register]": async (login_1, password_0)=>{
                await registerUser(login_1, password_0);
                router.push("/login");
            }
    ...
    if ($[10] === Symbol.for("react.memo_cache_sentinel")) {
        t6 = ({
            "SessionProvider[refreshUser]": (updatedUser)=>{
                setUser(updatedUser);
                store.set("user", JSON.stringify(updatedUser));
            }
        })["SessionProvider[refreshUser]"];
        $[10] = t6;
    } else {
        t6 = $[10];
    }
    const refreshUser = t6;
    let t7;
    if ($[11] !== logout || $[12] !== ready || $[13] !== register || $[14] !== sessionId || $[15] !== user) {
        t7 = {
            sessionId,
            user,
            setUser,
    ...
    let t8;
    if ($[17] !== children || $[18] !== t7) {
        t8 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(SessionContext.Provider, {
            value: t7,
            children: children
        }, void 0, false, {
            fileName: "[project]/context/SessionContext.js",
            lineNumber: 199,
            columnNumber: 10
        }, this);
        $[17] = children;
...
_s(SessionProvider, "LurSj1achFZXdhKCwiHjDONS8W4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = SessionProvider;
function _SessionProviderUseState2() {
    return ("TURBOPACK compile-time truthy", 1) ? getCachedUser() : "TURBOPACK unreachable";
}
function _SessionProviderUseState() {
    return ("TURBOPACK compile-time truthy", 1) ? store.get("session_id") : "TURBOPACK unreachable";
}
const useSession = ()=>{
    _s1();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(1);
...
//# sourceMappingURL=_1vpbdot._.js.map